...
- **外観**: **background-color**: `#fdf5e6`、**color**: `#333`、**border**: `1px solid #e1dbbd`、**border-radius**: `5px`、**padding**: `15px`、**overflow-x**: `auto`
- 必要に応じて **font-family**: `monospace` を付けてよい（テキスト本編のサンプルコードなどで読みやすさを優先する場合）。
